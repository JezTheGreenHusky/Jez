...
let reproductor = () => {
    ...
    let lista_musica = [
        ["Super Galaxy Rumble", "https://images3.alphacoders.com/759/thumb-350-759298.png"],
        ["2", "https://images3.alphacoders.com/759/thumb-350-759298.png"],
        ["3", "https://images3.alphacoders.com/759/thumb-350-759298.png"]
    ]
    console.log(lista_musica[0][0])
    ...
    botones.addEventListener("click", (elem) => {
        ...
        if(elemento.matches(".fa-play-circle")){
           ...
           box.innerHTML += `
               <audio class="audio" controls id="${lista_musica[index][0]}">
                   <source src="${lista_musica[index][0]}" type="audio/mp3">
               </audio>
           `;
...
let resumen_jugador = "http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=7823223CAD5CD4EB1F21E8E4A8069BAB&steamids=76561199041830855"
let ultimos_juegos = "http://api.steampowered.com/IPlayerService/GetRecentlyPlayedGames/v0001/?key=7823223CAD5CD4EB1F21E8E4A8069BAB&steamid=76561199041830855&format=json";
