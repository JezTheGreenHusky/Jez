window.addEventListener("load", ()=> {
    ...
    azar.addEventListener("click", () => {
        let lista = [
            ...
            '<iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1832815500&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/nctsmusic" title="ncts" target="_blank" style="color: #cccccc; text-decoration: none;">ncts</a> · <a href="https://soundcloud.com/nctsmusic/next-original-mix" title="NCTS - NEXT! [Brazilian Phonk]" target="_blank" style="color: #cccccc; text-decoration: none;">NCTS - NEXT! [Brazilian Phonk]</a></div>',
            ...
            '<iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/766661554&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/cody-de-leon-126962318" title="Jack Howl" target="_blank" style="color: #cccccc; text-decoration: none;">Jack Howl</a> · <a href="https://soundcloud.com/cody-de-leon-126962318/lone-friends-on-the-wild-side" title="Lone Friends on the Wild Side" target="_blank" style="color: #cccccc; text-decoration: none;">Lone Friends on the Wild Side</a></div>'
        ];
